...
// Portfolio category -> quoter project type, to preselect it when arriving
// from "Quote project" in the modal.
...
function getQuoteHref(category: string) {
  ...
  return type ? `/en/quote?type=${type}` : '/en/quote';
}
        ...
        <section className="pt-32 pb-16 bg-gradient-to-b from-brand-light/80 to-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="inline-flex items-center gap-2.5 px-4 py-2.5 mb-5 rounded-2xl bg-brand-lavender/80 backdrop-blur-md text-brand-navy border border-brand-lavender/50 shadow-lg shadow-brand-blue/15 animate-fade-in-up">
              ...
              <span className="font-medium text-[11px] sm:text-sm tracking-wider uppercase">Our work</span>
            </div>
        ...
        <section className="py-8">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ProjectDetailModal
              ...
              quoteHref={selectedProject ? getQuoteHref(selectedProject.category) : '/en/quote'}
            />
          </div>
        </section>
      </main>
