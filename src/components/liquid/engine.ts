...
// marching squares. It is framework-free and stateless beyond its inputs. The
// heavy work (grid sample + contour) only runs when something actually changed —
// the caller sets inputs then calls compute(); identical inputs return the
// cached path.
